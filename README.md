...
=
Welcome to a backup library of Lean's  git source of OpenWrt and packages
=
...
3. 使用 `git clone https://github.com/hellohjp/lede` 命令下载好源代码，然后 `cd lede` 进入目录
...
你可以自由使用，但源码编译二次发布请注明Lean的 GitHub 仓库链接 https://github.com/coolsnowwolf/lede 谢谢合作！
=
...
![wechat](https://github.com/coolsnowwolf/lede/blob/master/doc/wechat_donate.jpg)
